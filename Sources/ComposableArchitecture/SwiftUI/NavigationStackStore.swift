...
public struct NavigationStackStore<State: Identifiable, Action, Root: View, Destination: View>: View {
...
private struct NavigationDestinationView<State: Identifiable, Destination: View>: View {
